...
def compute_scalp_signal(
    ...
    *,
    ...
    bullish_rsi_ctx = bool((struct_pre_long or liquidity_event or orb_event or reclaim_attempt_long or vwap_event) and ((macd_build_long_pts >= 3) or macd_pre_long or macd_event))
    bearish_rsi_ctx = bool((struct_pre_short or liquidity_event or orb_event or reclaim_attempt_short or vwap_event) and ((macd_build_short_pts >= 3) or macd_pre_short or macd_event))
    strong_bullish_rsi_ctx = bool(pro_trigger or vwap_event or early_pre_long or (pre_trigger_near and reclaim_attempt_long and macd_event and (struct_pre_long or liquidity_event or orb_event)))
    strong_bearish_rsi_ctx = bool(pro_trigger or vwap_event or early_pre_short or (pre_trigger_near and reclaim_attempt_short and macd_event and (struct_pre_short or liquidity_event or orb_event)))
    rsi_pre_long = bool(
    ...
    **_ignored: object,
    ...
    def _build_ride_entry_geometry(conviction_score: float) -> dict[str, object]:
        ...
        if actionable_local:
            ...
            if tape_mode_enabled:
                ...
                try:
                    ...
                    continuation_mode_local = bool(
                        ...
                        and (structure_phase_local in ("BREAK_AND_HOLD", "ACCEPT_AND_GO", "EXTEND_THEN_PULLBACK"))
            ...
            if elite_runaway_local or continuation_mode_local:
    ...
    score = _cap_score(pts + ride_zone_adj + ride_cont_strength_adj + adx_modifier)
